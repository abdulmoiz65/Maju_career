...
<body>
  ...
  <div class="card p-4">
    <div class="container max-600">
      ...
      {{-- Application Form --}}
      <form id="careerForm" action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        {{-- 🔹 Include Job Type Specific Form --}}
        ...
        {{-- 🔹 Submit Button --}}
        <button id="submitBtn" type="submit" class="btn btn-primary mt-3 w-100">
          Submit Application
        </button>
      </form>
