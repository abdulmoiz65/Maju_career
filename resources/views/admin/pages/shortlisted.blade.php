  ...
  <div class="col-lg-12 grid-margin stretch-card mx-auto">
    <div class="card">
      <div class="card-body">
        ...
        <!-- 📋 Applications Table with checkboxes -->
        <form method="POST" action="{{ route('admin.applications.downloadResumes') }}">
          @csrf
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              @forelse($applications as $app)
                <tr>
                  <td><input type="checkbox" name="applications[]" value="{{ $app->id }}"></td>
                  <td>
                  ...
                  <td>
                    ...
                    <form method="POST" action="{{ route('admin.applications.unshortlist', $app->id) }}" class="d-inline">
                      @csrf
                      <button class="btn btn-danger btn-sm" onclick="return confirm('Remove from shortlist?')">
                          Remove
                      </button>
                    </form>
                  </td>
